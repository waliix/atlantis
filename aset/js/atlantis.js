...
$(document).ready(function(){
	...
	if(!minimize_sidebar){
		...
		if($('.wrapper').hasClass('sidebar_minimize')){
			...
			minibutton.html('<i class="bi bi-three-dots-vertical"></i>');
		}
		...
		minibutton.on('click', function() {
			if (mini_sidebar == 1) {
				...
				minibutton.html('<i class="bi bi-list"></i>');
				mini_sidebar = 0;
			} else {
	...
	if(!toggle_overlay_sidebar){
		...
		if($('.wrapper').hasClass('is-show')){
			...
			overlaybutton.html('<i class="bi bi-three-dots-vertical"></i>');
		}
		...
		overlaybutton.on('click', function() {
			if (overlay_sidebar_open == 1) {
				...
				overlaybutton.html('<i class="bi bi-list"></i>');
				overlay_sidebar_open = 0;
			} else {
